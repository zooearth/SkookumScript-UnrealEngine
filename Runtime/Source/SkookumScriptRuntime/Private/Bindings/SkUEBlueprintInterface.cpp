...
void SkUEBlueprintInterface::exec_method(FFrame & stack, void * const result_p, SkInstance * this_p)
  ...
  SkInvokedMethod imethod(nullptr, this_p, function_entry.m_sk_method_p, a_stack_allocate(function_entry.m_sk_method_p->get_invoked_data_array_size(), SkInstance*));
  ...
  function_entry.m_sk_method_p->invoke(&imethod, nullptr, &result_instance_p);
