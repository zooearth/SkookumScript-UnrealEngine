...
void FSkookumScriptRuntime::StartupModule()
  ...
  //$Revisit m_on_post_engine_init_handle  = UEngine::OnPostEngineInit.AddRaw(this, &FSkookumScriptRuntime::on_post_engine_init);
...
void FSkookumScriptRuntime::ShutdownModule()
  ...
  //$Revisit UEngine::OnPostEngineInit.Remove(m_on_post_engine_init_handle);
...
void FSkookumScriptRuntime::tick_game(float deltaTime)
  {
  // HACK for 4.11 to emulate OnPostEngineInit delegate
  if (m_is_first_tick)
    {
    on_post_engine_init();
