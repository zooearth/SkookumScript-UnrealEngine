...
bool FSkookumScriptGenerator::ShouldExportClassesForModule(const FString & module_name, EBuildModuleType::Type module_type, const FString & module_generated_include_folder) const
  ...
  if (should_export_project && !should_export_engine && module_type != EBuildModuleType::Game)
    {
...
bool FSkookumScriptGenerator::GenerationTarget::is_valid() const
  {
...
FString FSkookumScriptGenerator::GenerationTarget::get_ini_file_path() const
  {
